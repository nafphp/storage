...
final class StorageManager
{
    ...
    public function disk(?string $name = null): Filesystem
    {
        ...
        if (!is_string($class) || !is_subclass_of($class, StorageAdapterInterface::class)) {
            throw new StorageException("Storage disk '$name' must name an adapter implementing " . StorageAdapterInterface::class . '.');
        }
        ...
        try {
            ...
            return $this->disks[$name] = new Filesystem($adapter, $url);
